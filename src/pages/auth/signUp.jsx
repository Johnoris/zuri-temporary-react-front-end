        ...
        <div className="sign-up-wrapper">
            ...
            <div className="right-flex">
                    ...
                    <form className="w-100">
                        ...
                        <div className="w-100 align-center">
                            ...
                            <div className="input">
                                ...
                                />
                                <img src={
                                        require("../../assets/images/view-password-icon.png")
                                    }
                                    alt=""/>
                            </div>
                            <h1 className="password-requirements">Password must contain upper case, Lower case, number and a special character</h1>
                        </div>
                ...
                <div className="google-wrapper">
                    <GoogleLogin className="google" buttonText="Login with Google"
